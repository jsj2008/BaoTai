...
- (void)settingAutoLayout{
    ...
    [self.inputTextField autoPinEdgesToSuperviewEdgesWithInsets:UIEdgeInsetsMake(0, 0, 0, 0) excludingEdge:ALEdgeLeft];
//    [self.inputTextField autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:0];
//    [self.inputTextField autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:0];
//    [self.inputTextField autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:50 *Balance_Width];
