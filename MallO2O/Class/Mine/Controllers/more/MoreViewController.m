...
- (void) initData {
    tableViewArray = @[
                       ...
                       @[NSLocalizedString(@"moreFeedback", nil),
    ...
    switch (indexPath.section) {
        case 0:
            switch (indexPath.row) {
                case 0:
                {
                    [self jumpWebView:@"http://baotai.youzhiapp.com/action/ac_more/yz_about" andTitle:NSLocalizedString(@"moreAboutApp", nil)];
                }
                    break;
                 case 1:
                {
                    [self jumpWebView:@"http://baotai.youzhiapp.com/action/ac_more/privacy" andTitle:NSLocalizedString(@"morePrivacyRights", nil)];
                }
                    break;
        ...
        case 2:
            switch (indexPath.row) {
                case 0:
                {
                    [self jumpWebView:@"http://baotai.youzhiapp.com/action/ac_more/help" andTitle:NSLocalizedString(@"moreUseHelp", nil)];
                }
                    break;
                    
                case 1:
                    [self jumpWebView:@"http://baotai.youzhiapp.com/action/ac_more/code_img" andTitle:NSLocalizedString(@"moreCodeSharing", nil)];
                    break;
