...
- (void)getLocationFromMapViewPoint{
    CLLocationCoordinate2D dddd = [_baiduMapView convertPoint:self.baiduMapView.center toCoordinateFromView:self.baiduMapView];
    nowLocation = dddd;
}
