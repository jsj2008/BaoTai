...
- (void)setRightButton{
    ...
    rightBtn.frame     = CGRectMake(0, SCREEN_HEIGHT-50, SCREEN_WIDTH, 50);
//    rightBtn = [[UIButton alloc] initForAutoLayout];
    rightBtn.backgroundColor = Color(17, 176, 244, 1);
//    rightBtn.imageEdgeInsets            = UIEdgeInsetsMake(0, 0, 0, -30);
    ...
    [rightBtn setTitle:NSLocalizedString(@"addAdressDetailTitle", nil) forState:UIControlStateNormal];
//    [rightBtn setBackgroundImage:[UIImage imageNamed:@"add"] forState:UIControlStateNormal];
//    [rightBtn setBackgroundImage:[UIImage imageNamed:@"add"] forState:UIControlStateHighlighted];
//       self.tableView.tableHeaderView = rightBtn;
//    [self.view addSubview:rightBtn];
    [[[UIApplication sharedApplication].delegate window] addSubview:rightBtn];
