...
- (void) initData {
    ...
    AddAdrsModel *modelThree = [AddAdrsModel setModelData:NSLocalizedString(@"addAdrsInforCellTelephoneTitle", nil) andString:NSLocalizedString(@"addAdrsInforCellTelephoneTitle", nil)];
...
//    AddAdrsModel *modelFour = [AddAdrsModel setModelData:NSLocalizedString(@"addAdrsInforCellTelephoneTitle", nil) andString:NSLocalizedString(@"addAdrsInforCellTelephonePlaceholder", nil)];
    ...
    addAdrsArray = [NSMutableArray arrayWithObjects:modelOne,modelTwo,modelThree, nil];
}
...
- (void)initInfoData{
    ...
    AddAdrsModel *modelThree = [AddAdrsModel setModelData:@"手机号" andString:_addressModel.telString];
//    AddAdrsModel *modelFour = [AddAdrsModel setModelData:@"手机号" andString:_addressModel.telString];
    infoArray = [NSMutableArray arrayWithObjects:modelOne,modelTwo,modelThree, nil];
}
...
//    NSString *aaa = [array[2] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    if ([array[2] length] != 11 || ![UZCommonMethod inputString:array[2]]) {
...
- (void) settingUIAutoLayout {
    ...
    [_addAdrsTableView autoSetDimension:ALDimensionHeight toSize:126 * Balance_Heith];
}
