...
- (void)pushDataToUrl{
    NSString *url = [SwpTools swpToolGetInterfaceURL:@"comment_insert"];//connect_url(@"comment_insert");
    NSString *textString = _inputTextView.text;
    [SVProgressHUD showWithStatus:@"正在提交评价" maskType:SVProgressHUDMaskTypeBlack];
...
- (void)setRightButton{
    ...
    [rightBtn setBackgroundImage:[UIImage imageNamed:@"commit_v_no"] forState:UIControlStateNormal];
