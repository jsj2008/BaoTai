...
- (void)settingAutoLayout{
    ...
    _statusLabel.textColor = UIColorFromRGB(DefaultColor);
...
//    [NSString stringWithFormat:@"%@%@%@  %@", modela.goodsNum, NSLocalizedString(@"TheNumberOf", nil), NSLocalizedString(@"Commodity", nil), NSLocalizedString(@"Total", nil)];
    ...
    _totalMoneyLabel.text = [NSString stringWithFormat:@"%@%@",NSLocalizedString(@"Money", nil), modela.goodsMoney];//[@"￥" stringByAppendingString:modela.goodsMoney];
}
