...
- (void)setAutoLayout{
    ...
    [_homeBtnImgView autoSetDimension:ALDimensionWidth toSize:40.0f * Balance_Width];
    [_homeBtnImgView autoSetDimension:ALDimensionHeight toSize:40 * Balance_Heith];
    /*===设置属性===*/
