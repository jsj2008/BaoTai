...
- (void)setAutoLayout{
    ...
    [_recTitleLabel autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:14.0f * Balance_Heith];
...
//    [_recContentLabel autoSetDimension:ALDimensionHeight toSize:20 * Balance_Heith];
//    [_recContentLabel autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:_recImgView withOffset:5 * Balance_Width];
//    [_recContentLabel autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:10 * Balance_Heith];
...
//    [_distance autoPinEdgeToSuperviewEdge:ALEdgeRight  withInset:15];
    ...
    [_distance autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:14 * Balance_Heith];
    [_distance autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:self.recImgView withOffset:5 * Balance_Width];
...
//    _recContentLabel.textColor = UIColorFromRGB(0x989898);
    ...
    _distance.textColor = UIColorFromRGB(DefaultColor);
    //设置属性======//
}
...
- (void)setData{
    [self.recImgView sd_setImageWithURL:[NSURL URLWithString:_listModel.secondImgUrlText] placeholderImage:[UIImage imageNamed:@""]];
    self.recTitleLabel.text = _listModel.secondTitleText ;
//    self.recContentLabel.text = _listModel.secondShopName;

    self.distance.text = [NSLocalizedString(@"Money", nil) stringByAppendingString:_listModel.secondNowPriceText];
}
