...
- (void)setAutoLayout:(int)i{
    if (i < 4) {
        /*
            第一层的view和image
         */
        [_buttonBackView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:SCREEN_WIDTH/4*i];
        [_buttonBackView autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:0];
        [_buttonBackView autoSetDimension:ALDimensionWidth toSize:SCREEN_WIDTH/4];
    ...
    if (i >= 4) {
        /*
         第二层的view和image
         */
        [_buttonBackView autoPinEdgeToSuperviewEdge:ALEdgeLeft withInset:SCREEN_WIDTH/4*(i - 4)];
