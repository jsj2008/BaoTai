...
//    [rightBtn setTitle:@"筛选" forState:UIControlStateNormal];
    ...
    [rightBtn setImage:[UIImage imageNamed:@"collection_list_no"] forState:UIControlStateNormal];
...
- (void)selectGood{
    [UIView animateWithDuration:0.5 animations:^{
        if (!hidderIdentifier) {
            ...
            [rightBtn setImage:[UIImage imageNamed:@"list_collection_no"] forState:UIControlStateNormal];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    return CGSizeMake(Balance_Width * 158.5, 200* Balance_Heith);
}
