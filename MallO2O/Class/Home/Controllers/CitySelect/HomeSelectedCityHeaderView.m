...
- (UIButton *)homeSelectedCityDescView {
    ...
    if (!_homeSelectedCityDescView) {
        ...
        [_homeSelectedCityDescView settingSubmitButton:_homeSelectedCityDescView backgroundColor:[UIColor whiteColor] setTitle:@"" fontSize:16 fontColor:[UIColor grayColor] target:self action:@selector(clickButton:) buttonTag:0];
