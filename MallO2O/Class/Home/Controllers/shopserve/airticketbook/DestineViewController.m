...
@interface DestineViewController ()<UIWebViewDelegate>
...
@implementation DestineViewController {
...
- (void)postRequst {
    NSString *urlStr = [NSString stringWithFormat:@"http://%@/app_action/ac_reserve/plane_reserve",baseUrl];
