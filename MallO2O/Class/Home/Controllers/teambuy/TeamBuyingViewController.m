 ...
 */
- (void) settingNav {
    [self setNavBarTitle:NSLocalizedString(@"teamBuyingNavigationTitle", nil) withFont:NAV_TITLE_FONT_SIZE];
    [self setBackButton];
}
...
//        _teamBuyCollectionView.backgroundColor = [UIColor redColor];
    }
